...
public class GlobalExceptionHandler {
    ...
    public ErrorResponse handleResourceNotFoundException(ResourceNotFoundEx e,
                                                         WebRequest request) {
        ErrorResponse errorResponse = new ErrorResponse();
        errorResponse.setTimestamp(new Date());
        errorResponse.setPath(request.getDescription(false).replace("uri=", ""));
     ...
     * @return
     */
    @ExceptionHandler(InvalidDateEx.class)
    ...
    public ErrorResponse handleDuplicateKeyException(InvalidDateEx e, WebRequest request) {
        ErrorResponse errorResponse = new ErrorResponse();
        errorResponse.setTimestamp(new Date());
        errorResponse.setPath(request.getDescription(false).replace("uri=", ""));
